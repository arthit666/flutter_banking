...
class ColorThemeLight extends ColorTheme {
  @override
  Color get primaryColor => const Color(0xFF1CDAC5);

  @override
  Color get secondaryColor => const Color(0xFF508855);

  @override
  Color get primaryTextColor => const Color(0xFF404040);

  @override
  Color get secondaryTextColor => const Color(0xFFAEAEAE);
  ...
  @override
  Color get primaryIconColor => const Color(0xFF565656);
